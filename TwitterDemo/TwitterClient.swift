...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    static let sharedInstance = TwitterClient(baseURL: NSURL(string: "https://api.twitter.com")!, consumerKey: "jQ04HPsp0pGMKL1M1ob7zWyFl", consumerSecret: "i4T7ppMoFVedwgkjPp24DyHTmud5DDmGz6a8pxqTVsCql6Edfn")
